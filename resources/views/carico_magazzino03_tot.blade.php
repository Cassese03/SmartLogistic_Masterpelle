        ...
        <header class="row m-0 fixed-header">
            <div class="left">
                <a style="padding-left:20px;"
                   href=<?php if (substr($fornitore->Cd_CF, 0, 1) == 'F') echo "/magazzino/carico02/$cd_do"; else echo "/magazzino/carico2/$cd_do"; ?> ><i
                        class="material-icons">arrow_back_ios</i></a>
            </div>
            <div class="col center">
                <a href="#" class="logo">
                    <figure><img src="/img/logo_arca.png" alt=""></figure>
                    Documenti (<?php echo $cd_do ?>)</a>
            </div>
            <div class="right">
        ...
        <div class="page-content">
            <div class="content-sticky-footer">
                ...
                <ul class="list-group" id="ajax">
                           ...
                           class="media">
                            <div class="media-body">
                                <h5><?php echo $cd_do ?> N.<?php echo $do->NumeroDoc ?>
                                    Del <?php echo date('d/m/Y', strtotime($do->DataDoc)) ?></h5>
                                    <?php if ($do->NumeroDocRif != null && $do->DataDocRif != null){ ?>
                                <p>Codice: <?php echo $do->NumeroDocRif ?>
                                    del <?php echo date('d/m/Y', strtotime($do->DataDocRif)) ?></p>
                                <?php } ?>
                            </div>
                        </a>
                    </li>
                    ...
                    <?php } ?>
                    <button type="button" class="btn btn-success btn-sm" style="width:100%;background-color: red"
                            onclick="gotobolla()"> Mostra meno Documenti
                    </button>
        ...
        <form method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>Fornitore:<br><small><?php echo $fornitore->Descrizione ?></small></h3><input
                        class="form-control" type="number" placeholder="Inserisci Numero Documento" id="NumeroDoc"
                        value="<?php echo ($numero_documento) ? $numero_documento:1; ?>" readonly>
                    <label>Data Documento</label>
                    <input class="form-control" type="text" placeholder="Data Del Documento" id="DataDoc"
                           value="<?php echo date('Y-m-d') ?>" readonly>

                    <label>Numero Documento Rif</label>
                    <input class="form-control" type="text" placeholder="Inserisci Numero Documento Del Fornitore"
                           id="NumeroDocRif" value="" autocomplete="off">

                    <label>Data Documento Rif</label>
                    <input class="form-control" type="date" placeholder="Data Del Documento" id="DataDocRif" value=""
                           autocomplete="off">
{{--

                    <?php if ($cd_do == 'DDT') { ?>
                    <label>Destinazione</label>
                    <input class="form-control" list="destinazione" type="text" placeholder="Destinazione del documento"
        ...
        <form method="post">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label>Data Documento</label>
                    <input class="form-control" type="text" placeholder="Data Del Documento" id="DataDoc"
                           value="<?php echo $d->DataDoc ?>" readonly>
                        <?php
                    ...
                    <button type="button" style="width: 100%;margin-top: 10px;background-color: red"
                            class="btn btn-primary" onclick="redirect(<?php echo $d->Id_DoTes ?>);">Da Completare
                    </button>
                    <?php }else{ ?>
                    <button type="button" style="width: 100%;margin-top: 10px" class="btn btn-primary"
                            onclick="redirect(<?php echo $d->Id_DoTes ?>);">Vedi
                    </button>
                    <?php } ?>
                    <br><br>
                    <?php } ?>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Chiudi</button>
                    <button type="button" class="btn btn-primary" onclick="redirect_plus('1')">Vedi Piu Documenti
                    </button>
                </div>
            </div>
        </form>
...
<script type="text/javascript">
    ...
    function redirect(dotes) {
        ...
        if (dotes != '') {
            ...
            top.location.href = "/magazzino/carico4/<?php echo $id_fornitore ?>/" + dotes;
        }
    }
    ...
    function redirect_plus(int) {
        ...
        if (int != '1') {
            ...
            if (dotes == '')
                ...
                top.location.href = "/magazzino/carico04/<?php echo $id_fornitore ?>/" + dotes;
        }
    }
