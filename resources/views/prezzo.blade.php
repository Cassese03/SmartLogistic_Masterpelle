    ...
    <div class="page">
        ...
        <div class="page-content">
            <div class="content-sticky-footer">
                ...
                <div class="w-100">
                    <h1 class="text-center text-white title-background">Cerca PREZZO</h1>
                </div>
...
<script type="text/javascript">
    ...
    function change_prezzo() {
        prezzo = $('#modal_colori option:selected').attr('prezzo');
        document.getElementById('modal_Prezzo').value = prezzo;
